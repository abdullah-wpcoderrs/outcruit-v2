...
-- Scheduling fields (idempotent)
ALTER TABLE public.talent_list_candidates
  ADD COLUMN IF NOT EXISTS batch_number INTEGER,
  ADD COLUMN IF NOT EXISTS interview_date TEXT,
  ADD COLUMN IF NOT EXISTS interview_time_slot TEXT,
  ADD COLUMN IF NOT EXISTS meeting_venue_url TEXT,
