                ...
                <DialogContent>
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={async () => {
                            ...
                            setRenameError('');
                            try {
                                const res1 = await fetch(`/api/talent-lists/${id}`, { method: 'PATCH', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ jobTitle: next }) });
                                if (!res1.ok) throw new Error('Failed to rename list');
